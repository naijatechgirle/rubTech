...
<head>
    ...
    <title>rubtech.com/fire-alarms</title>
        ...
        <div class="row">
            <div class="col-xs-12 col-md-6">
                <div class="template-example">
                    <h2 class="text-center">Solar Powered Electric Fence</h2>
                    ...
                    <img src="./assets/images/fence.jpg" alt="fire alarm"
                        class="img-responsive"><br>
                    <p>Our solar powered electric fence is designed to create an electrical circuit when touched by a person or animal. A component called power energizer converts power into a brief high voltage pulse. One terminal of the power energizer releases an electrical pulse along a connected bare wire about once per second.
Our electric fence energizer is powered by solar which helps it constantly active even when there is power outage. Furthermore, our electric fence could be set-up to communicate to you any intrusion through the fence by sending an sms to your phone as well as setting off an alarm in your property.
</p>     
                </div>
            </div>
